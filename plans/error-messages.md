...
| `rotostats_error_missing_league_history` | `replacement_level()` (step-7 validation) | `seed_method = "historical_priors"` was requested but `league_history` is `NULL` | Pass a `league_history` object from `league_history()` |
